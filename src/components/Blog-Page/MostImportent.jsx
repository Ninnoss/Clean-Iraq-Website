...
export default function MostImportent(props) {
 ...
 return (
    ...
    <div className="test child" style={{backgroundImage: `url(${props.image}`}}>
    </div>
    </div>
    ...
    <div className='flex justify-center items-center gap-5 '>
        ...
        <div className='flex order-1 gap-2 '>
            <img src={images.share} alt="share logo"  className=' order-1'/>
            <p className=' text-[#6C757D]'>1K مشاركة</p>
        </div>
        <div className='flex gap-4 '>
            <span className=' order-1'><img src={images.dot} alt="dor" className=' pt-2'/></span>
    ...
    <div className='max-w-[350px] flex flex-col gap-2'>
        ...
        <div>
        <button className='text-[#548C67] underline'>
        اقرأ المزيد
        </button>
        </div>
    </div>
