  ...
  return (
    <div
      ...
      <div className={`p-7 flex flex-col space-y-8  lg:items-center mx-auto ${!isLTR ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
        <div className={`sm:w-10/12 md:w-6/12 lg:w-4/12 mx-auto my-8 text-highlightBlack`}>
          <h3 className="pb-12 text-Heading-2">{title}</h3>
          <p className="text-justify mb-6 text-Body-L">{description}</p>
          <p className="text-justify text-Body-M">{description2}</p>
        </div>
