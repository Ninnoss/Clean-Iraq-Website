...
const LatestNews = () => {
  ...
  return (
    <section className="bg-highlightGrey relative py-16">
      ...
      <h2 className="bg-primaryGreen/40 scratch-effect text-Heading-4 absolute top-[3%] md:top-[8%] start-[10%] md:start-[5%]">
        {t('blogs-page.latest-blogs-section.header')}
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center gap-24 my-10 px-10 ">
