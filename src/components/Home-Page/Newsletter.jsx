    ...
    <section className="bg-lightPeach py-14 px-4 ">
      <div className="text-center mb-10">
        ...
        <p className="text-highlightBlack text-Body-L mt-10 ">
          ابق على اطلاع على حملاتنا وفعالياتنا وإعلاناتنا! لا تتردد في التسجيل
          مع البريد الإلكتروني الخاص بك.
        </p>
      </div>
      <form className="flex flex-col gap-y-6 md:flex-row justify-center items-center">
        <div className="flex bg-white rounded-full shadow-md">
          <label htmlFor="newsletter" className="p-3">
