...
const Form = () => {
    return <form className="flex flex-col items-center px-72 py-12 text-Body-L">
        ...
        <div className="w-full text-center">
            ...
            <p className=" py-2 text-Subtitile-M font-bold">ملاحظة: اذا ما تحب تشاركنا معلوماتك، ممكن تحضر بدون ما تملي الاستمارة، بس ما راح تحصل على اي وحدة من مطبوعات الحملة (مثلا تيشيرت، مطارة مي، ميدالية، وغيرها)</p>
        </div>
